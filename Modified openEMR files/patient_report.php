...
<span class='title'><?php xl('Share Patient Records','e'); ?></span>&nbsp;&nbsp;

<br/>
<br/>

<input type="submit" class="button" value="<?php echo xla('Open Sharing Application'); ?>" onclick="location.href='localhost:8080/MainSharePage.jsp'" />
